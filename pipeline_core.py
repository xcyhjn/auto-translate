    ...
    *,
    ...
    if skip_burn:
        ...
        manifest = {
            ...
            "files": build_manifest_file_list(output_dir, plan, audio_override_path=audio_override_path),
        }
    ...
    manifest = {
        ...
        "qa": qa_summary,
        "burn_plan": burn_plan,
        "files": build_manifest_file_list(output_dir, plan, audio_override_path=audio_override_path, output_video_name=output_video_name),
    }
    manifest["subtitle_mode"] = plan.subtitle_mode
    manifest["subtitle_output"] = {
        "mode": plan.subtitle_mode,
